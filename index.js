...
const marqueeDisplayed = getComputedStyle(root).getPropertyValue("--marquee-elements-displayed");
const marqueeTrack = document.querySelector(".marquee-track");

root.style.setProperty("--marquee-elements", marqueeTrack.children.length);

for (let i = 0; i < marqueeDisplayed; i++) {
  marqueeTrack.appendChild(marqueeTrack.children[i].cloneNode(true));
}
